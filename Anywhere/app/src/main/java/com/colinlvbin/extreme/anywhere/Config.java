...
public class Config {
    ...
    public static final String SERVER_IP="http://108.61.247.246:5000";
    //活动请求编号
    ...
    public static final int SETTINGS_TO_PASSWORD_REQUESTCODE=1003;
    ...
    public static final int CREAT_POST_TO_ADD_PIC_REQUESTCODE=1008;
