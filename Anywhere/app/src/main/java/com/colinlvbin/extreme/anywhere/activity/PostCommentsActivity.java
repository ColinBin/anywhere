...
public class PostCommentsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog=RoutineOps.ShowProgressDialog(PostCommentsActivity.this,"正在获取评论");
        ...
        switch(v.getId()){
            case R.id.submit_comment_button_post_comments:
                ...
                if(TextUtils.isEmpty(comment_content)){
                    RoutineOps.MakeToast(PostCommentsActivity.this,"评论不能为空");
                    return;
                }
                    ...
                    if(response.getHeaders().getResponseCode()==200){
                        ...
                        try {
                            ...
                            if(permission==Config.GET_COMMENT_LIST_SUCCESS){
                                ...
                                RoutineOps.MakeToast(PostCommentsActivity.this,"当前没有评论");
                            }
                    ...
                    if(response.getHeaders().getResponseCode()==200){
                        ...
                        try {
                            ...
                            if(permission==Config.ADD_COMMENT_SUCCESS){
                                ...
                                RoutineOps.MakeToast(PostCommentsActivity.this,"添加成功");
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
