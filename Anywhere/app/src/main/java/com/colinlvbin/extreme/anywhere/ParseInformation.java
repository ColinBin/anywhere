        ...
        try{
            for(int i=0;i<postsInformation.length();i++){
                ...
                Post currentPost=new Post(currentPostJsonObject.getInt("post_id"),
                        currentPostJsonObject.getString("title"),"",currentPostJsonObject.getString("location_description"),
                        currentPostJsonObject.getString("street"),currentPostJsonObject.getString
                        ("district"),currentPostJsonObject.getString("city"),
                        currentPostJsonObject.getString("country"),currentPostJsonObject
    ...
    public static Post ParsePost(JSONObject postInformation){
        ...
        try{
            post=new Post(postInformation.getInt("post_id"),
                    ...
                    ("content"),postInformation.getString("location_description"),
                    postInformation.getString("street"),postInformation.getString
                    ("district"),postInformation.getString("city"),
                    postInformation.getString("country"),postInformation
