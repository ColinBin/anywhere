...
public class Post implements Serializable{
    ...
    public Post(int post_id,String title,String content,String location_description,String
            street,String district,String city,String country,double longitude,double latitude,
